...
{{-- <link href="{{ asset('backend/fonts/fontsGoogleapis.css')}}" rel="stylesheet"> --}}
...
<!--Morris.js [ OPTIONAL ]-->
<link href="{{ asset('backend/plugins/morris-js/morris.min.css') }}" rel="stylesheet">
...
<script src="{{ asset('backend/js/custom-js-me.js') }}"></script>
