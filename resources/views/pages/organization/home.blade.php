                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="background-color: #fff">
                            <div class="panel">
                                <div class="panel-heading" style="display: flex; justify-content: space-between;">
                                    <h5 class="panel-title">Bảng Tổ chức</h5>
                                </div>
                                <div class="panel-body">
                                    <div class="col-sm-6 table-toolbar-left">
										<a href="{{ route($table.'.create') }}" id="demo-btn-addrow" class="btn btn-purple btn-labeled fa fa-plus">Thêm Tổ chức</a>
									</div>
                                    ...
                                    <table class="table table-bordered table-striped table-hover toggle-circle default footable-loaded footable demo-foo-pagination">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="background-size: 200px;width:200px; {{ $item->image ? "height:200px; background-position: center;" : "" }} background-repeat: no-repeat; background-image:url('../organization/{{ $item->image }}');"></td>
