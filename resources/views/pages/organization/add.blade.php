...
@section('content')
    <div id="content-container">
        ...
        <ol class="breadcrumb">
            <li><a href="#">Thêm tổ chức</a></li>
        </ol>
        <div class="row" style="display:flex; justify-content:center;">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Thêm tổ chức</h3>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        pattern="https://.*" class="form-control" name="website" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea required name="description" placeholder="Nội dung" rows="13" class="form-control" style="width: 380px; height: 233px;"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
