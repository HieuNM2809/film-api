                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required class="form-control" id="id_user" name="id_user">
                                            ...
                                            @foreach ($dataForeign['user'] as $item)
                                                <option value="{{ $item->id }}" {{ $data->id_user == $item->id ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required class="form-control" id="id_title_type" name="id_title_type">
                                            ...
                                            @foreach ($dataForeign['titleType'] as $item)
                                                <option value="{{ $item->id }}"{{ $data->id_title_type == $item->id ? 'selected' : '' }}>
                                                    {{ $item->type }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required class="form-control" id="id_organizations" name="id_organizations">
                                            ...
                                            @foreach ($dataForeign['organization'] as $item)
                                                <option value="{{ $item->id }}" {{ $data->id_organizations == $item->id ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group" style="height:254px;">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <img id="image_Avatar" alt="your image"
                                                ...
                                                src="{{ isset($id) ? '/post/' . $data->feature_image : '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea required name="content" placeholder="Nội dung" rows="13" class="form-control" style="width: 380px; height: 233px;">{{$data->content??""}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
