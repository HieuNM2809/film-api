        ...
        <div id="page-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select id="status_filter" class="custom_filter form-control" name="status">
                                                ...
                                                <option value="unpublish">Không hoạt động</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <table id="table-data" class="add-niftycheck" data-toggle="table" data-locale="vi-VN"
                        data-toolbar="#table-toolbar" data-url='{{url('admin/list-user')}}'
                        ...
                        <thead style="background: #5fa2dd; color: white;">
                            <tr>
                                ...
                                <th scope="col" data-field="fullName" data-sortable="true">Tên đầy đủ</th>
                                <th scope="col" data-field="codeStaff" data-sortable="true">Mã nhân viên</th>
                                <th scope="col" data-field="birthDay" data-sortable="true">Ngày sinh</th>
                                <th scope="col" data-field="position" data-sortable="true">Vị trí</th>
                                <th scope="col" data-field="createdAt" data-sortable="true">Ngày tham gia</th>
                                <th scope="col" data-field="loginLast" data-sortable="true">Lần login gần nhất</th>
            ...
            <script type="text/javascript">
                ...
                function actionColumnEdit(value, row, index) {
                    ...
                    var groupBtn = [
                        '<a href="{{url('/admin/permision-user')}}/' + value + '" ',
                        'class="add-tooltip btn btn-warning btn-icon icon-lg btn-xs" data-placement="top" data-original-title="Thêm quyền">',
